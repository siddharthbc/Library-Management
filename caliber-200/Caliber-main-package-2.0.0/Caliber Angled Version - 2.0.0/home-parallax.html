            ...
            <div class="topbar " data-effect="fadeIn">
                <div class="menu">
                    <div class="primary inviewport animated delay4" data-effect="fadeInRightBig">
                        <div class='cssmenu'>
                            <!-- Primary Menu - Start -->
                            <ul class='menu-ul' id='parallax-nav-primary'>              <li class="homelink"><a class="" href="#header">Home</a></li>
                            <li class="aboutlink"><a class="" href="#about">About</a></li>
                            <li class="serviceslink"><a class="" href="#services">Services</a></li>
                            <li class="teamlink"><a class="" href="#team">Team</a></li>
                        </ul>
                        <!-- Primary Menu - End -->
                    </div>
                </div>
                <div class="black inviewport animated delay4" data-effect="fadeInLeftBig">
                    <div class='cssmenu'>
                        <!-- Dark Menu - Start -->
                        <ul class='menu-ul' id='parallax-nav-dark'>             <li class="capabilities"><a class="" href="#capabilities">Skills</a></li>
                        <li class="portfolio"><a class="" href="#portfolio">Portfolio</a></li>
...
<!-- Section End - Clients -->
<!-- Section Start - Blogs -->
<section class='bg-lightgray padding-bottom-0 ' id='blog'><div class="container">
<div class="row">
